...
class Node:
    ...
    def __init__(
        ...
        # Lưu vào object attribute. Node này sẽ dự đoán lớp có lớp thường xuyên nhất
        self.yhat = yhat

        # Lưu số lượng quan sát trong nút
        self.n = len(Y)

        # Khởi tạo ode trái phải là node rỗng
        self.left = None
        self.right = None

        # Giá trị mặc định cho các phần tách (đặ trưng tốt nhất, giá trị tốt nhất)
    ...
    def ma(x: np.array, window: int) -> np.array:
        """
        Tính trung bình động của danh sách đã cho
        """
    ...
    def best_split(self) -> tuple:
        ...
        # Tính năng tốt nhất mặc định và split tốt nhất
        best_feature = None
        best_value = None
        ...
        return (best_feature, best_value) # trả về tính năng tốt nhất và giá trị tốt nhất
